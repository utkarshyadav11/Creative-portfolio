  ...
  return (
    <Column maxWidth="m">
      ...
      <Row fillWidth s={{ direction: "column" }} horizontal="center">
        ...
        <Column className="max-[768px]:self-center" flex={9} maxWidth={40}>
          <Column
          ...
          >
            {about.calendar.display && (
              <Row
                ...
                marginBottom="m"
                vertical="center"
                className="max-[768px]:self-center"
                style={{
            ...
            <Heading className="max-[768px]:text-center" variant="display-strong-xl">
              {person.name}
            </Heading>
            <Text
